...
2. Click on Create a Data Source ![Copy This Report Window](\Images\CopyThisReport.png)
3. Click Google Sheets from the Google Connectors and select the Google Sheet you created for this project ![]()
